...
def process_message(ch, method, properties, body):
    ...
    try:
        ...
        print(f"Processing SMS for Contact ID: {contact_id}")
        # Тут можна додати імітацію відправки SMS
        print(f"Simulating SMS sending for Contact ID: {contact_id}")
...
channel.basic_consume(queue='sms_queue', on_message_callback=process_message, auto_ack=True)
